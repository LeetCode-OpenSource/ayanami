...
Split all possible states with multiple values in **State** is bordering. The more elegant way is store all posible states in single value, TypeScript will ensure you always rendering with the right state:
